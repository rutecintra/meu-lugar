        ...
        <div className="flex items-center justify-end">
          ...
          <div className="flex items-center space-x-1 sm:space-x-4">
            ...
            <button
              ...
              className={`flex items-center space-x-1 sm:space-x-2 px-2 sm:px-3 py-1 sm:py-2 rounded-lg transition-colors ${
                isTeacherMode
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-medium hidden sm:inline">Dados</span>
              </button>
              ...
              {showExportMenu && (
                <div className="absolute top-full right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg z-50 min-w-32">
                  <button
                    ...
                    className="w-full px-3 py-2 text-left text-xs sm:text-sm text-gray-700 hover:bg-gray-100 rounded-t-lg"
                  >
                    Exportar dados
                  </button>
                  <label className="w-full px-3 py-2 text-left text-xs sm:text-sm text-gray-700 hover:bg-gray-100 cursor-pointer block rounded-b-lg">
                    Importar dados
                    <input
                      type="file"
                      accept=".json"
