    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-green-50 border border-green-200 rounded-xl p-6">
        ...
        <div className="text-green-800 text-sm space-y-2">
          <p>
            <strong>Reflexão Pessoal:</strong> Use este quiz para ajudar os alunos a 
            refletirem sobre suas preferências e conexões emocionais com lugares.
          </p>
          <p>
            <strong>Discussão em Grupo:</strong> Após o quiz, organize uma discussão 
            sobre as diferentes preferências e como elas podem coexistir.
          </p>
          <p>
            <strong>Extensão:</strong> Peça aos alunos para criarem um "mapa emocional" 
            da escola ou bairro baseado em como se sentem em diferentes áreas.
          </p>
        </div>
      </div>
    </div>
